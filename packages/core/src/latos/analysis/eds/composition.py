...
_LINES: tuple[tuple[str, str, float], ...] = (
    ...
    ("F", "Ka", 0.677), ("Na", "Ka", 1.041), ("Mg", "Ka", 1.254),
    ("Al", "Ka", 1.486), ("Si", "Ka", 1.740), ("P", "Ka", 2.013),
    ("S", "Ka", 2.307), ("Cl", "Ka", 2.622), ("K", "Ka", 3.313),
    ("Ca", "Ka", 3.690), ("Ti", "Ka", 4.508), ("Cr", "Ka", 5.411),
    ("Mn", "Ka", 5.894), ("Fe", "Ka", 6.398), ("Co", "Ka", 6.924),
    ("Ni", "Ka", 7.471), ("Cu", "La", 0.930), ("Cu", "Ka", 8.040),
    ("Zn", "Ka", 8.630), ("Ga", "Ka", 9.241), ("Ge", "Ka", 9.874),
    ("Se", "La", 1.379), ("Se", "Ka", 11.220), ("Br", "La", 1.480),
    ("Mo", "La", 2.293), ("Ag", "La", 2.984), ("Cd", "La", 3.133),
    ("Sn", "La", 3.444), ("Sb", "La", 3.604), ("Te", "La", 3.769),
    ("I", "La", 3.937), ("Cs", "La", 4.286), ("Ba", "La", 4.466),
    ("W", "Ma", 1.775), ("W", "La", 8.398), ("Au", "Ma", 2.123),
    ("Au", "La", 9.713), ("Pb", "Ma", 2.342), ("Pb", "La", 10.551),
    ("Bi", "Ma", 2.419), ("Bi", "La", 10.839),
)
